...
ndarry = NDArrayImport["imagenet_vgg11-0000.params"];
...
getCN[i_] := ConvolutionLayer[
	"Weights" -> ndarry["arg:vgg0_conv" <> i <> "_weight"],
	"Biases" -> ndarry["arg:vgg0_conv" <> i <> "_bias"],
	"PaddingSize" -> 1, "Stride" -> 1
]
getFC[i_, n_] := LinearLayer[n,
	"Weights" -> ndarry["arg:vgg0_dense" <> i <> "_weight"],
	"Biases" -> ndarry["arg:vgg0_dense" <> i <> "_bias"]
]
...
Export["imagenet_vgg11.WMLF", mainNet]
