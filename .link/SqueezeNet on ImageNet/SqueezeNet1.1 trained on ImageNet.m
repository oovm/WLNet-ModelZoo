...
params = NDArrayImport["squeezenet1.1-0000.params"];
...
getCN[i_, p_, s_] := ConvolutionLayer[
	"Weights" -> params["arg:squeezenet1_conv" <> ToString[ i ] <> "_weight"],
	"Biases" -> params["arg:squeezenet1_conv" <> ToString[i] <> "_bias"],
...
Export["SqueezeNet1.1 trained on ImageNet.WXF", mainNet]
