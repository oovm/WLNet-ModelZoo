...
params = Import["resnet18.pth.wxf"];
...
decoder = NetDecoder[{"Class", Import["class_names_100.ckpt.json"]}]
mainNet = NetChain[
	{
		{
			getCN["0.0", 2, 3],
...
export = <|
	...
	"Decoder" -> decoder
|>;
Export["ResNet-20 trained on Danbooru2018.MAT", export, "WXF", PerformanceGoal -> "Speed"]
