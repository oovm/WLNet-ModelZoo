...
params = NDArrayImport["ProSR_4x-0000.params"];
...
$head = NetChain@{
	...
	PaddingLayer[{{0, 0}, {1, 1}, {1, 1}}, "Padding" -> "Reflected"],
	ConvolutionLayer[
		"Weights" -> params["arg:init_conv_2.conv.1.weight"],
		"Biases" -> params["arg:init_conv_2.conv.1.bias"],
		"PaddingSize" -> 0, "Stride" -> 1
	]
};
resNet = NetChain[{
	...
	PaddingLayer[{{0, 0}, {1, 1}, {1, 1}}, "Padding" -> "Reflected"],
	ConvolutionLayer[
		"Weights" -> params["arg:reconst_2.final_conv.conv.1.weight"],
		"Biases" -> params["arg:reconst_2.final_conv.conv.1.bias"],
		"PaddingSize" -> 0, "Stride" -> 1
	]
}
];
...
(*here should use bicubic in fact*)
	ResizeLayer[{Scaled[4], Scaled[4]}, "Resampling" -> "Linear"],
...
Export["ProSR4x trained on Flickr2K.WXF", mainNet]
