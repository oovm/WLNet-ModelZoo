...
params = NDArrayImport["imagenet_resnet152_v1s-0000.params"];
...
extractor = NetChain[{
	...
	getBlock2[2, 2],
	Table[getBlock3[2, i], {i, 3, 21, 3}],
	getBlock2[3, 2],
	Table[getBlock3[3, i], {i, 3, 105, 3}],
	getBlock2[4, 2],
...
Export["Resnet152-V1s trained on ImageNet.WXF", mainNet]
