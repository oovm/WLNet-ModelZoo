...
params = NDArrayImport["imagenet_resnet18_v1b-0000.params"];
...
extractor = NetChain[{
	...
	Table[getBlock3[1, i], {i, 0, 2, 2}],
	getBlock2[2, 2],
	Table[getBlock3[2, i], {i, 2, 2, 2}],
	getBlock2[3, 2],
	Table[getBlock3[3, i], {i, 2, 2, 2}],
	getBlock2[4, 2],
	Table[getBlock3[4, i], {i, 2, 2, 2}],
...
Export["Resnet18-V1b trained on ImageNet.WXF", mainNet]
