...
<< DeepMath`;
DeepMath`NetMerge;
$name = "ComixGAN Comic Style Transfer Gamma";
...
getName[s_] := TemplateApply["/model_weights/`1`/`1`", {s}];
...
mainNet = NetChain[{
	...
	{
		getDN["conv2d_transpose_1", 2, 0],
		PartLayer[{All, 2 ;; All, 2 ;; All}],
		getCW["conv2d_29", 1, 1],
		getIN["instance_normalization_23"],
		Ramp
	},
	{
		getDN["conv2d_transpose_2", 2, 0],
		getCW["conv2d_30", 1, 1],
		PartLayer[{All, 2 ;; All, 2 ;; All}],
